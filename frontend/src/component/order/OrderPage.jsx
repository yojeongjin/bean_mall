      ...
      <OrderInner>
        <Section className='order' style={{padding: '80px 0'}}>
          ...
          <OrderInfoWrap isShow={show}>
            {orderItemList}
            <OrderAmount style={{fontWeight: 400}}>
              배송비 : {fee.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} 원
            </OrderAmount>
            ...
            <ContentWrap>
              <RecipientContents>
                ...
                <InputContainer>
                  ...
                  <div style={{flexDirection: "cloumn"}}>
                    <Input 
                      id="phonenumber"
                      type="number"
                      required
                    ...
                    />
                    <span style={{fontSize: "12px", color: "#252525", marginTop: "10px"}}
                    >('-' 기호를 빼고 입력해주세요.)</span>
                  </div>
                </InputContainer>
              </RecipientContents>
