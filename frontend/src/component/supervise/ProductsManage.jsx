...
export default function ProductsManage(props) {
  ...
  const uploadProduct = () => {
    if(contents.indexOf('') === -1) {
      if(photo === null) {
        ...
        axios.patch('https://www.theine.shop/api/getuser', body)
        .then((res) => {
          alert(res.data.msg)
        ...
        axios.patch('https://www.theine.shop/api/upload', form, {
  ...
  const soldoutProduct = () => {
    ...
    axios.patch('https://www.theine.shop/api/products', body)
    .then((res) => {
      alert(res.data.msg)
      setSale(false)
      setSoldout(true)
  ...
  const deleteProduct = () => {
      axios.delete('https://www.theine.shop/api/products', {params: {
        idProducts: data.idProducts
      }})
    .then((res) => {
      alert(res.data.msg)
